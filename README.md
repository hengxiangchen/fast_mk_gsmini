...
In this directory, we realize gelsightmini at the maximal reading frequence of 25hz for marker deformation, providing the source code and compilation files for find_marker.so (located at find_marker_generator/src/lib/find_marker.so). 
